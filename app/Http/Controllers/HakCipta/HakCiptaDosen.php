...
class HakCiptaDosen
{
    public static function index(Request $request)
    {
        ...
        return view('hak-cipta.index-dosen');
    }
    ...
    public static function create()
    {
        ...
        return view('hak-cipta.create-dosen')
            ->with('negara', $negara)
            ->with('doskar', $doskar);
    }
    ...
    public static function store(HakCiptaStoreRequest $request)
    {
        ...
        $hakCipta = HakCipta::create($request->validated());
        $hakCipta->status = 1;
        ...
        return redirect()->route('hak-cipta.index')->with('success', 'Hak Cipta berhasil dibuat');
    }
    ...
    public static function show(string $id)
    {
        ...
        return view('hak-cipta.show-dosen')
            ->with('id', $id)
            // ->with('doskar', $doskar)
    ...
    public static function edit(string $id)
    {
        ...
        return view('hak-cipta.edit-dosen')
            ->with('id', $id)
            // ->with('doskar', $doskar)
            ->with('hakCipta', $hakCipta)
            ->with('jenisHakCipta', $jenisHakCipta)
