...
class PatenDosen
{
    ...
    public static function pengajuanAwal(Request $request)
    {
        ...
        return view('paten.pengajuan-awal-dosen')
            ->with('tahun', $tahun)
            ->with('jenisPaten', $jenisPaten)
            ->with('statusPaten', $statusPaten);
    }
    ...
    public static function terdaftar(Request $request)
    {
        ...
        return view('paten.terdaftar-dosen')
            ->with('tahun', $tahun)
            ->with('jenisPaten', $jenisPaten)
            ->with('statusPaten', $statusPaten);
    }
    ...
    public static function kelengkapanDokumen(Request $request)
    {
        ...
        return view('paten.kelengkapan-dokumen-dosen')
            ->with('tahun', $tahun)
            ->with('jenisPaten', $jenisPaten)
            ->with('statusPaten', $statusPaten);
    }
    ...
    public static function mediasi(Request $request)
    {
        ...
        return view('paten.mediasi-dosen')
            ->with('tahun', $tahun)
            ->with('jenisPaten', $jenisPaten)
            ->with('statusPaten', $statusPaten);
    }
    ...
    public static function granted(Request $request)
    {
        ...
        return view('paten.granted-dosen')
            ->with('tahun', $tahun)
            ->with('jenisPaten', $jenisPaten)
            ->with('statusPaten', $statusPaten);
    }
    ...
    public static function create()
    {
        ...
        return view('paten.create-dosen')
            ->with('jenisPaten', $jenisPaten)
            ->with('doskar', $doskar);
    }

    public static function store(PatenStoreRequest $request)
    {
        $folderName = 'uploads/paten/';
        $paten = Paten::create($request->validated());
        $paten->status_paten_id = 1;
        $paten->tanggal = date('Y-m-d');
        ...
        return redirect()->route('paten.pengajuan-awal')->with('success', 'Paten berhasil dibuat');
    }
    ...
    public function edit(string $id)
    {
        $paten = Paten::find($id);
        $jenisPaten = JenisPaten::all();
        $pengusul = Pengusul::where('paten_id', $id)->orderBy('urutan')->get();

        return view('paten.edit-dosen')
            ->with('id', $id)
            ->with('paten', $paten)
            ->with('jenisPaten', $jenisPaten)
