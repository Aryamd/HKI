...
class MerekDosen
{
    ...
    public static function create()
    {
        ...
        return view('merek.create-dosen')
            ->with('jenisMerek', $jenisMerek)
            ->with('doskar', $doskar);
    }

    public static function store(MerekStoreRequest $request)
    {
        $folderName = 'uploads/merek/';
        $merek = Merek::create($request->validated());
        $merek->tanggal = date('Y-m-d');
