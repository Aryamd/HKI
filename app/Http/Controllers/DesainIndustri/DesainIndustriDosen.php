...
class DesainIndustriDosen
{
    public static function index(Request $request)
    {
        ...
        return view('desain-industri.index-dosen');
    }
    ...
    public static function create()
    {
        ...
        return view('desain-industri.create-dosen')
            ->with('jenisDesainIndustri', $jenisDesainIndustri)
            ->with('subJenisDesainIndustri', $subJenisDesainIndustri)
            ->with('doskar', $doskar);
    }

    public static function store(DesainIndustriStoreRequest $request)
    {
        $folderName = 'uploads/desain-industri/';
        $desainIndustri = DesainIndustri::create($request->validated());
        ...
        return redirect()->route('desain-industri.index')->with('success', 'Desain Industri berhasil dibuat');
    }
    ...
    public static function show(string $id)
    {
        ...
        return view('desain-industri.show-dosen')
            ->with('id', $id)
    ...
    public static function edit(string $id)
    {
        ...
        return view('desain-industri.edit-dosen')
            ->with('id', $id)
            ->with('desainIndustri', $desainIndustri)
            ->with('jenisDesainIndustri', $jenisDesainIndustri)
            ->with('subJenisDesainIndustri', $subJenisDesainIndustri)
