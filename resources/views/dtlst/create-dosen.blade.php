...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Buat DTLST Baru</li>
                    </ol>
                </div>
                <h4 class="page-title">Buat DTLST Baru</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form class="needs-validation" enctype="multipart/form-data" action="{{ route('dtlst.store') }}" method="post" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="position-relative mb-3">
                                    ...
                                    <select name="jenis_dtlst_id" id="jenis_dtlst_id" class="form-select" required>
                                        ...
                                        @foreach ($jenisDTLST as $item)
                                            <option value="{{ $item->id }}" {{ old('jenis_dtlst_id') == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-tooltip">
                                ...
                                <div class="position-relative mb-3">
                                    ...
                                    <select name="sub_jenis_dtlst_id" id="sub_jenis_dtlst_id" class="form-select" required>
                                        ...
                                        @foreach ($subJenisDTLST as $item)
                                            <option value="{{ $item->id }}" {{ old('sub_jenis_dtlst_id') == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-tooltip">
