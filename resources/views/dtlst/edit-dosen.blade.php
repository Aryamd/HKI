...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Edit DTLST Baru</li>
                    </ol>
                </div>
                <h4 class="page-title">Edit DTLST Baru</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form class="needs-validation" enctype="multipart/form-data" action="{{ route('dtlst.update', $id) }}" method="post" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="position-relative mb-3">
                                    <label for="judul" class="form-label">Judul</label>
                                    <input type="text" class="form-control" id="judul" name="judul" value="{{ $dtlst->judul }}" placeholder="Judul" required />
                                    <div class="invalid-tooltip">
                                        Mohon diisi kolom Judul.
                                    </div>
                                </div>
                                <div class="position-relative mb-3">
                                    <label for="jenis_dtlst_id" class="form-label">Jenis</label>
                                    <select name="jenis_dtlst_id" id="jenis_dtlst_id" class="form-select" required>
                                        <option value="">Pilih Jenis</option>
                                        @foreach ($jenisDTLST as $item)
                                            <option value="{{ $item->id }}" {{ $dtlst->jenis_dtlst_id == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-tooltip">
                                ...
                                <div class="position-relative mb-3">
                                    <label for="sub_jenis_dtlst_id" class="form-label">Sub Jenis</label>
                                    <select name="sub_jenis_dtlst_id" id="sub_jenis_dtlst_id" class="form-select" required>
                                        <option value="">Pilih Sub Jenis</option>
                                        @foreach ($subJenisDTLST as $item)
                                            <option value="{{ $item->id }}" {{ $dtlst->sub_jenis_dtlst_id == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-tooltip">
                                ...
                                <div class="position-relative mb-3">
                                    ...
                                    <input type="date" class="form-control" id="tanggal" name="tanggal" value="{{ $dtlst->tanggal }}" required />
                                    <div class="invalid-tooltip">
                                ...
                                <div class="position-relative mb-3">
                                    ...
                                    <textarea class="form-control" id="uraian" name="uraian" rows="15" placeholder="Uraian Singkat" required>{{ $dtlst->uraian }}</textarea>
                                    <div class="invalid-tooltip">
                            ...
                            <div class="col-lg-6">
                                <div class="position-relative mb-3">
                                    <label for="file_gambar_dtlst" class="form-label">Gambar DTLST</label>
                                    <div class="row">
                                        <div class="col-6">
                                            <input type="file" class="form-control" id="file_gambar_dtlst" name="file_gambar_dtlst" />
                                        </div>
                                        <div class="col-6">
                                            <label class="form-label mt-1">{{ $dtlst->file_gambar_dtlst }}</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="position-relative mb-3">
                                    <label for="file_uraian_dtlst" class="form-label">Uraian DTLST</label>
                                    <div class="row">
                                        <div class="col-6">
                                            <input type="file" class="form-control" id="file_uraian_dtlst" name="file_uraian_dtlst" />
                                        </div>
                                        <div class="col-6">
                                            <label class="form-label mt-1">{{ $dtlst->file_uraian_dtlst }}</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="position-relative mb-3">
                                    <label for="file_surat_pernyataan_kepemilikan" class="form-label">Surat Pernyataan Kepemilikan DTLST</label>
                                    <div class="row">
                                        <div class="col-6">
                                            <input type="file" class="form-control" id="file_surat_pernyataan_kepemilikan" name="file_surat_pernyataan_kepemilikan" />
                                        </div>
                                        <div class="col-6">
                                            <label class="form-label mt-1">{{ $dtlst->file_surat_pernyataan_kepemilikan }}</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="position-relative mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <label class="form-label mt-1">{{ $dtlst->file_surat_pernyataan_pengalihan_hak }}</label>
                                        </div>
                                    </div>
                                </div>
