...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Buat Merek Baru</li>
                    </ol>
                </div>
                <h4 class="page-title">Buat Merek Baru</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form class="needs-validation" enctype="multipart/form-data" action="{{ route('merek.store') }}" method="post" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="position-relative mb-3">
                                    ...
                                    <input type="file" class="form-control" id="file_uraian_merek" name="file_uraian_merek" required />
                                </div>
                                <div class="position-relative mb-3">
                                    <label for="file_ttd_pemohon" class="form-label">Tanda Tangan Pemohon</label>
                                    <input type="file" class="form-control" id="file_ttd_pemohon" name="file_ttd_pemohon" required />
                                </div>
                                <div class="position-relative mb-3">
                                ...
                                <div class="position-relative mb-3">
                                    ...
                                    <input type="file" class="form-control" id="file_pernyataan_lisensi" name="file_pernyataan_lisensi" required />
                                </div>
                                <div class="position-relative mb-3">
                                    <label for="file_permohonan_merek" class="form-label">Formulir Permohonan Merek</label>
                                    <input type="file" class="form-control" id="file_permohonan_merek" name="file_permohonan_merek" required />
                                </div>
                                <div class="position-relative mb-3">
                                ...
                                <div class="position-relative mb-3">
                                    ...
                                    <input type="file" class="form-control" id="file_surat_pengalihan_hak" name="file_surat_pengalihan_hak" required />
                                </div>
                                <div class="position-relative mb-3">
                                ...
                                <div class="position-relative mb-3">
                                    ...
                                    <input type="file" class="form-control" id="file_penjelasan_pendaftaran_merek" name="file_penjelasan_pendaftaran_merek" required />
                                </div>
                                <div class="position-relative mb-3">
                                    <label for="file_penjelasan_perpanjangan_merek" class="form-label">Surat Penjelasan Perpanjangan Merek</label>
                                    <input type="file" class="form-control" id="file_penjelasan_perpanjangan_merek" name="file_penjelasan_perpanjangan_merek" required />
                                </div>
                                <div class="position-relative mb-3">
                                    <label for="file_penjelasan_pengalihan_hak" class="form-label">Surat Penjelasan Pengalihan Hak</label>
                                    <input type="file" class="form-control" id="file_penjelasan_pengalihan_hak" name="file_penjelasan_pengalihan_hak" required />
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        $.get("{{ route('merek.get-jenis-merek') }}", function(data, status) {
            $('#jenis_merek_id').empty();
            $('#jenis_merek_id').append($(document.createElement('option')).prop({
                value: -1,
                text: 'Pilih Jenis'
            }));
