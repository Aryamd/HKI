            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Edit Desain Industri</li>
                    </ol>
                </div>
                <h4 class="page-title">Edit Desain Industri</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <form class="needs-validation" enctype="multipart/form-data" action="{{ route('desain-industri.update', $id) }}" method="post" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="position-relative mb-3">
                                    <label for="file_sertifikat" class="form-label @if (\App\Helpers\Utils::isNullOrEmpty($desainIndustri->file_sertifikat)) text-danger @endif">Sertifikat Desain Industri</label>
                                    <div class="row">
                                        <div class="col-6">
                                            <input type="file" class="form-control" id="file_sertifikat" name="file_sertifikat" />
                                        </div>
                                        <div class="col-6">
                                            @if (\App\Helpers\Utils::isNullOrEmpty($desainIndustri->file_sertifikat))
                                            <label class="form-label mt-1 text-danger">Sertifikat belum diupload</label>
                                            @else
                                            <label class="form-label mt-1">{{ $desainIndustri->file_sertifikat }}</label>
                                            @endif
                                        </div>
                                    </div>
                                </div>
