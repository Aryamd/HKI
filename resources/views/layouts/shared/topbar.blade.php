    ...
    <div class="container-fluid">
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <span class="pro-user-name ms-1">
                        {{ Auth::user()->doskar ? Auth::user()->doskar->nama : '' }} <i class="mdi mdi-chevron-down"></i>
                    </span>
                </a>
                <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                    ...
                    {{-- <form method="POST" action="">
                        @csrf --}}
                        <a href="{{ route('logout.index') }}" class="dropdown-item notify-item">
        ...
        <div class="logo-box">
            <a href="" class="logo logo-dark text-center">
                <span class="logo-sm">
                    <img src="{{asset('assets/images/logo_pnb_kotak.png')}}" alt="" height="72">
                    <!-- <span class="logo-lg-text-light">UBold</span> -->
                </span>
                <span class="logo-lg">
                    <img src="{{asset('assets/images/logo_pnb.jpg')}}" alt="" height="72">
